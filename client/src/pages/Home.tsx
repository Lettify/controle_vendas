    ...
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-teal-50 to-cyan-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          {/* Funcionários ativos */}
          <Card className="border-teal-200 shadow-lg hover:shadow-xl transition-all">
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-gray-600 mb-1">
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Card className="border-emerald-100 hover:border-emerald-300 hover:shadow-xl transition-all cursor-pointer group" onClick={() => navigate("/employees")}>
              <CardContent className="p-6">
            ...
            <Card className="border-teal-100 hover:border-teal-300 hover:shadow-xl transition-all cursor-pointer group" onClick={() => navigate("/sales")}>
              <CardContent className="p-6">
                <div className="flex items-start gap-4">
            ...
            <Card className="border-cyan-100 hover:border-cyan-300 hover:shadow-xl transition-all cursor-pointer group" onClick={() => navigate("/statistics")}>
              <CardContent className="p-6">
                <div className="flex items-start gap-4">
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-1">
                    <h3 className="text-xl font-bold text-gray-900">Painel de Administração</h3>
                ...
                <Button onClick={() => navigate("/admin/access-codes")} className="bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 shadow-lg">
